...
<table>
  <tr>
    <td align="center"><b>MLP / Transformer</b></td>
    <td align="center"><b>Diffusion (Diffusers + DiT)</b></td>
    <td align="center"><b>Flow Matching</b></td>
  </tr>
  <tr>
    <td align="center">
      <video src="videos/mlp.mp4" controls width="360"></video>
    </td>
    <td align="center">
      <video src="videos/diffusion.mp4" controls width="360"></video>
    </td>
    <td align="center">
      <video src="videos/flow.mp4" controls width="360"></video>
    </td>
  </tr>
</table>

> 视频文件位于 [`videos/`](videos/)。本地复现录屏见下方 [闭环评估](#闭环评估) 一节（`save_video: true`）。
